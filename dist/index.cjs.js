...
var Bars = function Bars(_ref) {
  ...
  return React__default['default'].createElement("svg", _extends({
    ...
    viewBox: "0 0 135 140",
    className: "svg-loaders-svg".concat(className ? " ".concat(className) : '')
  }, props), React__default['default'].createElement("rect", {
    y: 10,
    width: 15,
    height: 120,
    rx: 6
...
var TailSpin = function TailSpin(_ref) {
  ...
  return React__default['default'].createElement("svg", _extends({
    ...
    viewBox: "0 0 38 38",
    className: "svg-loaders-svg".concat(className ? " ".concat(className) : '')
  }, props), React__default['default'].createElement("defs", null, React__default['default'].createElement("linearGradient", {
    x1: "8.042%",
    y1: "0%",
    x2: "65.682%",
    y2: "23.865%",
